              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1 truncate text-ink">
                    {w.type === "payout" ? (
                      <>
                        <span className="rounded bg-[rgba(167,139,250,0.15)] px-1.5 py-0.5 text-[0.58rem] font-bold text-payout">
                          payout on
                        </span>{" "}
                        D{w.day}{" "}
                  ...
                  <span
                    className={cn(
                      "shrink-0 font-bold",
                      w.type === "payout" ? "text-payout" : net >= 0 ? "text-live" : "text-loss"
                    )}
                  >
                    {net >= 0 ? "+" : ""}${net.toLocaleString()}
                  </span>
                  <button
                    className="shrink-0 rounded px-1.5 text-faint transition-colors hover:bg-[rgba(255,97,120,0.1)] hover:text-loss"
                    onClick={() => del(idx)}
