    ...
    <Dialog open={!!id} onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        ...
        <div className="mb-4 rounded-lg bg-panel2 px-2.5 py-2 font-mono text-[0.6rem] leading-relaxed text-faint">
          Day {day}: benchmark cost <b className="text-ink">${L.inv}</b> · win chance{" "}
          <b className="text-ink">{(L.p * 100).toFixed(1)}%</b> · forward EV{" "}
          <b className="text-ink">~${fwdEV(day).toFixed(0)}</b>
        </div>
