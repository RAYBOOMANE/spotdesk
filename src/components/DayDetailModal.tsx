  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        ...
        className="rounded-[7px] border border-line2 bg-void px-2.5 py-2 font-mono text-[0.8rem] text-ink focus:border-live focus:outline-none"
      />
    </div>
  );
}
              ...
              .map((w, i) => (
                ...
                >
                  ...
                  <span className="flex-1 text-ink">
                    {w.type === "payout" ? (
                      <>
                        <span className="text-payout">payout</span> D{w.day}{" "}
                  ...
                  <span className={w.type === "payout" ? "font-bold text-payout" : "font-bold text-live"}>
